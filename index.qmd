...
- [Chess game analytics with Stockfish](projects/chess_analytics.qmd) — end-to-end pipeline from the chess.com API through Stockfish engine evaluation to move-quality patterns across hundreds of games
