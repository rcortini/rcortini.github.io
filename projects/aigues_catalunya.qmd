...
producing the visualisation. It can also be
[downloaded here](../assets/aigues_catalunya/0.ACA_APIs_exploration.ipynb).

{{< embed ../assets/aigues_catalunya/0.ACA_APIs_exploration.ipynb >}}
